...
export const appIcons = {
  ...
  subway: { ios: 'tram.fill.tunnel', android: 'subway', web: 'subway' },
  tram: { ios: 'tram.fill', android: 'tram', web: 'tram' },
  ferry: { ios: 'ferry.fill', android: 'directions_boat', web: 'directions_boat' },
  transit: { ios: 'point.3.connected.trianglepath.dotted', android: 'commute', web: 'commute' },
  route: { ios: 'point.bottomleft.forward.to.point.topright.scurvepath', android: 'route', web: 'route' },
  rideshare: { ios: 'car.side.fill', android: 'local_taxi', web: 'local_taxi' },
  taxi: { ios: 'car.rear.fill', android: 'local_taxi', web: 'local_taxi' },
  shuttle: { ios: 'bus.doubledecker.fill', android: 'airport_shuttle', web: 'airport_shuttle' },
  ...
  'weather-clear': { ios: 'sun.max.fill', android: 'light_mode', web: 'light_mode' },
  'weather-partly-cloudy': {
    ios: 'cloud.sun.fill',
    android: 'partly_cloudy_day',
    web: 'partly_cloudy_day',
  },
  'weather-cloudy': { ios: 'cloud.fill', android: 'cloud', web: 'cloud' },
  'weather-fog': { ios: 'cloud.fog.fill', android: 'foggy', web: 'foggy' },
  'weather-rain': { ios: 'cloud.rain.fill', android: 'rainy', web: 'rainy' },
  'weather-showers': {
    ios: 'cloud.sun.rain.fill',
    android: 'rainy',
    web: 'rainy',
  },
  'weather-snow': { ios: 'cloud.snow.fill', android: 'weather_snowy', web: 'weather_snowy' },
  'weather-thunder': {
    ios: 'cloud.bolt.rain.fill',
    android: 'thunderstorm',
    web: 'thunderstorm',
  },
