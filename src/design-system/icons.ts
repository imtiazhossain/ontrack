...
export const appIcons = {
  ...
  suitcase: { ios: 'suitcase.fill', android: 'luggage', web: 'luggage' },
...
/** Gallery / docs grouping — every `appIcons` key must appear in exactly one section. */
export const appIconSections = [
  {
    id: 'categories',
    title: 'Categories',
    description: 'Activity and feature category marks.',
    icons: [
      'food',
      'gym',
      'work',
  ...
  },
  {
    id: 'travel',
    title: 'Travel',
    description: 'Trips, transport, lodging, weather, and roster.',
    icons: [
      'note',
      'itinerary',
      'suitcase',
  ...
  },
  {
    ...
    description: 'Timeline and checklist completion states.',
    icons: ['status-completed', 'status-skipped', 'status-upcoming'],
  },
  {
    id: 'exercises',
    title: 'Exercises',
    description: 'Workout movement marks.',
    icons: [
      'exercise-strength',
      'exercise-functional',
      'exercise-row',
...
export type AppIconSectionId = (typeof appIconSections)[number]['id'];
