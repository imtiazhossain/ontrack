...
/** Contact for privacy / terms / account deletion requests. */
export const ONTRACK_SUPPORT_EMAIL = 'imtihoss@gmail.com';

export const PRIVACY_POLICY_URL = `${ONTRACK_LEGAL_BASE_URL}/privacy`;
export const TERMS_OF_USE_URL = `${ONTRACK_LEGAL_BASE_URL}/terms`;

export const PRIVACY_POLICY_UPDATED = 'August 3, 2026';
