...
export const AgentUiIds = {
  ...
  travel: {
    ...
    list: {
      ...
      addTransport: 'ontrack.travel.list.addTransport',
      searchStays: 'ontrack.travel.list.searchStays',
      itinerary: 'ontrack.travel.list.itinerary',
      calendar: 'ontrack.travel.list.calendar',
      tripWeather: 'ontrack.travel.list.tripWeather',
      currency: 'ontrack.travel.list.currency',
      expenses: 'ontrack.travel.list.expenses',
      groupChat: 'ontrack.travel.list.groupChat',
      coTravelers: 'ontrack.travel.list.coTravelers',
